...
### The dataset and previous analyses

We obtained the dataset from !Kaggle[https://www.kaggle.com/datasets/yingwurenjian/chicago-divvy-bicycle-sharing-data], 
which takes a look at Divvy bike usership from 2014 to 2017. This particular dataset was 
obtained from processing both Divvy data and weather data in Chicago from the website wunderground.com.
